...
func setupRoutes(
	...
	}))
	{
		...
		protected.GET("/asm/resources/:id/task-profile", security.RequirePermission("mcp:read"), asmHandler.TaskProfile)
		...
		protected.POST("/asm/tasks/:id/stop", security.RequirePermission("mcp:write"), asmHandler.StopTaskHistory)
