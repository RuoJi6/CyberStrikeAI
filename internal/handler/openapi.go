...
func (h *OpenAPIHandler) GetOpenAPISpec(c *gin.Context) {
	...
	conversationEgressAuditModeRequestSchema := map[string]interface{}{
		...
		"description": "旧版兼容字段：compact 映射为 aggregationMode=all；full 映射为 none；off 映射为 enabled=false。",
	}
	conversationEgressAggregationModeRequestSchema := map[string]interface{}{
		"type": "string", "enum": []string{"all", "tools", "none"}, "default": "tools",
		"description": "Host 与 Container 通用。all 聚合全部高频流量；tools 仅聚合可信声明 fuzz 的 HTTP 流量（容器非 HTTP 协议保持行为聚合）；none 逐条记录。",
	}
	conversationRecordUpstreamFailuresSchema := map[string]interface{}{
		"type": "boolean", "default": false,
		"description": "Host 与 Container 通用。开启后记录端口拒绝、连接失败和上游超时；默认关闭以避免扫描不可达端口产生大量无用记录。策略阻断和安全异常不受此开关影响。",
	}
	...
	egressAuditEventSchema := map[string]interface{}{
		...
		"properties": map[string]interface{}{
			...
			"eventId":                   map[string]interface{}{"type": "string", "maxLength": 128},
			"runtimeMode":               map[string]interface{}{"type": "string", "enum": []string{"container", "host_mitm"}},
			"runtimeInstanceId":         map[string]interface{}{"type": "string", "maxLength": 128},
			"toolName":                  map[string]interface{}{"type": "string", "maxLength": 256},
			"executionId":               map[string]interface{}{"type": "string", "maxLength": 128},
			"toolCallId":                map[string]interface{}{"type": "string", "maxLength": 128},
			"activityScopeId":           map[string]interface{}{"type": "string", "maxLength": 128},
			...
			"aggregateKind":             map[string]interface{}{"type": "string", "enum": []string{"web-fuzz", "path-sweep", "unattributed-path-sweep", "port-scan", "target-scan", "dns-enumeration", "connection-burst", "datagram-burst", "request-burst"}},
	...
	egressAuditIntegritySchema := map[string]interface{}{
		"type":                 "object",
		"additionalProperties": false,
		"required":             []string{"status", "conversations", "events", "verifiedAt"},
		"properties": map[string]interface{}{
			"status":        map[string]interface{}{"type": "string", "enum": []string{"verified"}},
			"conversations": map[string]interface{}{"type": "integer", "minimum": 0},
			"events":        map[string]interface{}{"type": "integer", "minimum": 0},
			"verifiedAt":    map[string]interface{}{"type": "string", "format": "date-time"},
		},
	}
	...
	egressAuditListSchema := map[string]interface{}{
		...
		"properties": map[string]interface{}{
			...
			"integrity": map[string]interface{}{"$ref": "#/components/schemas/EgressAuditIntegrity"},
		},
	}
	...
	spec := map[string]interface{}{
			...
			"schemas": map[string]interface{}{
				...
				"CreateConversationRequest": map[string]interface{}{
					...
					"properties": map[string]interface{}{
						...
						"egressAggregationMode":  conversationEgressAggregationModeRequestSchema,
						"recordUpstreamFailures": conversationRecordUpstreamFailuresSchema,
				...
				"ContainerInitialization": map[string]interface{}{
					...
					"properties": map[string]interface{}{
						...
						"readinessStatus": map[string]interface{}{
							"type": "string",
							"enum": []string{"not_required", "pending", "validating", "ready", "failed"},
						},
						"readinessError":       map[string]interface{}{"type": "string"},
						"inventoryDigest":      map[string]interface{}{"type": "string"},
						"toolCount":            map[string]interface{}{"type": "integer", "minimum": 0},
		...
		"paths": map[string]interface{}{
			...
			"/api/conversations/{id}/egress-activity/stream": map[string]interface{}{
				"get": map[string]interface{}{
					...
					"parameters": []map[string]interface{}{
						...
						{"name": "runtime_mode", "in": "query", "schema": map[string]interface{}{"type": "string", "enum": []string{"all", "container", "host_mitm"}, "default": "all"}},
					},
					"responses": map[string]interface{}{
						"200": map[string]interface{}{
			...
			"/api/egress-audit-events": map[string]interface{}{
				"get": map[string]interface{}{
					...
					"parameters": []map[string]interface{}{
						...
						{"name": "event_type", "in": "query", "schema": map[string]interface{}{"type": "string", "default": "all", "enum": []string{"all", "dns", "http", "https", "connect", "tcp", "udp", "icmp", "health", "create", "start", "stop", "rebuild", "delete", "reconcile"}}},
			...
			"/api/egress-audit-events/integrity": map[string]interface{}{
				"get": map[string]interface{}{
					"tags": []string{"出站审计"}, "summary": "校验对话级审计 hash 链", "operationId": "verifyEgressAuditIntegrity",
					"description": "按访问范围重算每条事件 hash，并核对前序 hash、连续序号、事件数量和独立链头；检测修改、删除或重排时返回 409。",
					"parameters":  []map[string]interface{}{{"name": "conversation_id", "in": "query", "schema": map[string]interface{}{"type": "string", "maxLength": 128}}},
					"responses": map[string]interface{}{
						"200": map[string]interface{}{"description": "完整性校验通过", "content": map[string]interface{}{"application/json": map[string]interface{}{"schema": map[string]interface{}{
							"type": "object", "additionalProperties": false, "required": []string{"integrity"}, "properties": map[string]interface{}{"integrity": map[string]interface{}{"$ref": "#/components/schemas/EgressAuditIntegrity"}},
						}}}},
						"400": map[string]interface{}{"description": "参数无效"}, "401": map[string]interface{}{"description": "未授权"}, "403": map[string]interface{}{"description": "缺少审计读取权限"}, "409": map[string]interface{}{"description": "检测到审计链修改、删除或重排"},
					},
				},
			},
			...
			"/api/conversations/{id}/egress-audit": map[string]interface{}{
				...
				"put": map[string]interface{}{
					...
					"description": "Host 与 Container 共用。aggregationMode 的 all/tools/none 与 recordUpstreamFailures 会立即应用于后续流量；enabled 只控制实时网络活动与持久审计，流量证据仍捕获。mode 保留旧版兼容。",
					"parameters":  []map[string]interface{}{{"name": "id", "in": "path", "required": true, "schema": map[string]interface{}{"type": "string"}}},
					"requestBody": map[string]interface{}{"required": true, "content": map[string]interface{}{"application/json": map[string]interface{}{"schema": map[string]interface{}{"type": "object", "additionalProperties": false, "properties": map[string]interface{}{"enabled": map[string]interface{}{"type": "boolean"}, "aggregationMode": conversationEgressAggregationModeRequestSchema, "mode": conversationEgressAuditModeRequestSchema, "recordUpstreamFailures": conversationRecordUpstreamFailuresSchema}}}}},
