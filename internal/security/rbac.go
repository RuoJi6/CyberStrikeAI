...
var PermissionCatalog = map[string]string{
	...
	"traffic:read":                       "View captured traffic metadata",
	"traffic:read_sensitive":             "View captured traffic bodies and sensitive headers",
	"traffic:replay":                     "Edit and replay captured requests inside their original execution boundary",
	"traffic:write":                      "Retain and annotate captured traffic",
	"traffic:delete":                     "Delete captured traffic",
	"traffic_transform:read":             "View traffic transform metadata and validation reports",
	"traffic_transform:read_source":      "View immutable traffic transform source code",
	"traffic_transform:write":            "Create immutable traffic transform revisions and run offline tests",
	"traffic_transform:activate_observe": "Activate traffic transforms for passive decoding",
	"traffic_transform:activate_inline":  "Approve traffic transforms that can modify live traffic",
	...
	"egress:read":                        "View egress proxies, groups, and safe routing summaries",
	"egress:write":                       "Create and update egress proxies, groups, and proxy credentials",
	"egress:delete":                      "Delete egress proxies and groups",
}
